...
Y_1 <- rnorm(n, 1*reg1+1.5*reg2-1+2*abs(Xpred[,3]+1) + 2*Xpred[,4]+ exp(0.5*Xpred[,5])-0.5*1*abs(Xpred[,6]) - 1*1*abs(Xpred[,7]+1), 0.3)

Y_0 <- rnorm(n, 1*reg1+1.5*reg2-0+2*abs(Xpred[,3]+1) + 2*Xpred[,4]+ exp(0.5*Xpred[,5])-0.5*0*abs(Xpred[,6]) - 1*0*abs(Xpred[,7]+1), 0.3)
